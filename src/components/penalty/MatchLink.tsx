  ...
  return (
    <div className="relative flex h-lvh flex-col items-center justify-center gap-[80px]">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="translate-x-5 text-[32px] text-mainTextWhiteColor">
          공유해보세요 <ExclamationMarkIcon className="inline -translate-x-[5px]" width={40} height={40} />
        </div>
      </div>

      {/* 대결장 */}
      <div className="relative flex h-[280px] w-[70%] flex-col justify-evenly rounded-[20px] bg-[#404040]">
        ...
        <div className="px-8 text-[18px]">
          ...
          <div className="text-mainTextWhiteColor">{penalty}</div>
        </div>
      </div>
